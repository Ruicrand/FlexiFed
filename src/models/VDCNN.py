...
def VDCNN_9(m=69, l0=1024, num_classes=4):
    return VDCNN(ConvBlock, cfg['A'], m=m, l0=l0, num_classes=num_classes)


def VDCNN_17(m=69, l0=1024, num_classes=4):
    return VDCNN(ConvBlock, cfg['B'], m=m, l0=l0, num_classes=num_classes)


def VDCNN_29(m=69, l0=1024, num_classes=4):
    return VDCNN(ConvBlock, cfg['C'], m=m, l0=l0, num_classes=num_classes)


def VDCNN_49(m=69, l0=1024, num_classes=4):
    return VDCNN(ConvBlock, cfg['D'], m=m, l0=l0, num_classes=num_classes)
